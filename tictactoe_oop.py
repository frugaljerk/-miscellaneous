...
ALL_SPACE = list('123456789') # The keys for a TTT board
X, O, BLANK = 'X', 'O', ' '  #Constants for string values.

def main():
    """Runs a game of tic-tac-toe."""
    print('Welcome to tic-tac-toe!')
    gameBoard = TTTBoard()  # Create a TT board object.
...
class TTTBoard:
    ...
    def isValidSpace(self, space):
        ...
        return space in ALL_SPACE and self._spaces[space] == BLANK

    def isWinner(self, player):
        """Return True if player is a winner on this TTTBoard."""
        s, p = self._spaces, player  # Shorter names as "syntactic sugar".
        # Check for 3 marks across the 3 rows, 3 columns, and 2 diagnoals.
